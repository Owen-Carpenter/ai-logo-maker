          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-blue-200/50 p-8 text-neutral-900 space-y-6">
            ...
            <section>
              ...
              <div className="text-neutral-700">
                <p>By accessing and using AI Logo Maker ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-neutral-700 space-y-2">
                <p>AI Logo Maker provides artificial intelligence-powered logo generation services. Our service allows users to:</p>
            ...
            <section>
              ...
              <div className="text-neutral-700 space-y-4">
                ...
                <p>The AI Logo Maker service, including our AI models, software, and website content, is protected by copyright and other intellectual property laws. You may not copy, modify, or distribute our service content.</p>
            ...
            <section>
              ...
              <div className="text-neutral-700 space-y-4">
                ...
                <p>To the maximum extent permitted by law, AI Logo Maker shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the service.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-neutral-700">
                ...
                <ul className="list-none space-y-2 ml-4 mt-4">
                  ...
                  <li><strong>Address:</strong> AI Logo Maker, Legal Department</li>
                </ul>
              </div>
            </section>
